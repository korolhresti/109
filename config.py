...
") # Updated with user's provided DATABASE_URL

WEBHOOK_URL = os.getenv("https://one09-if3u.onrender.com")

MONOBANK_CARD_NUMBER = os.getenv("4441111153021484")

GEMINI_API_KEY = os.getenv("AIzaSyBJs77DoM3llifxy3qgYuRhaD8j5emv8_A")
